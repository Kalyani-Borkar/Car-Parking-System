...
import com.parkin.Model.Vehicle;
import com.parking.Exception.AppException;
...
public class TicketService {
     ...
     */
    public static TicketService createInstance(int numberOfSlots) {
        if(numberOfSlots < 1) {
     ...
     *         color)
     */
    public List<AllocationStatus> getStatus() {
